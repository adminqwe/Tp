 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/admins/comment/insert" method="post" enctype="multipart/form-data"> 
   <!--  @if(session('error'))
    ...
    <div class="mws-form-item">
      <script id="editor" type="text/plain"  name="connect" style="width:700px;height:500px;"></script>
    </div>
  </div>
      <div class="mws-form-row">
