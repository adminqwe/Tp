...
<div class="denglu_bt4">重置密码</div>
<form action="/doreset" method="post">


<div class="dl_yhm">重置密码：<input name="password" type="password" / style="width:160px; height:24px; line-height:24px; padding-left:5px;color:#3d4245; border:1px solid #e4e4e4;"></div>
<div class="dl_yhm">确认密码：<input name="repassword" type="password" / style="width:160px; height:24px; line-height:24px; padding-left:5px;color:#3d4245; border:1px solid #e4e4e4;"></div>
@if(count($errors)>0)
...
<div class="dl_dl"><input name="" type="submit" value="提 交" onmousedown="this.style.left='1px';this.style.top='1px';" onmouseup="this.style.left='0px';this.style.top='0px';" / style="width:135px; height:39px; border:none; background:url(/h/images/dl_dl.jpg); color:#FFF; font-size:14px; font-family:'微软雅黑'; position:relative;"></div>
</form>
<div class="denglu_sm">
<span style="color:#529014; font-weight:600;">如果您还不是本亲生活的会员?</span><br />
<span>30秒轻松注册，就可方便购物，赶紧点击下方注册</span>
</div>
<div class="denglu_hmzc"><a href="/home/register">立即注册</a></div>
