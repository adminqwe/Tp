...
<div class="denglu_nr2" style="background-color:#FFFFFF; height:380px;">
<div class="denglu_bt4">用户登录</div>
<form action="/home/dologin" method="post">

<div class="dl_yhm">用户名：<input name="email" type="text" id="key" value="用户名/您的邮箱" size="30"    
 ...
 @if(session('error'))
<center><span style="color:red">{{session('error')}}</span></center>
@endif       


<div class="dl_yhm">&nbsp;&nbsp;&nbsp;密码：<input name="password" type="password" / style="width:170px; height:24px; line-height:24px; padding-left:5px;color:#3d4245; border:1px solid #e4e4e4;"></div>

<div class="dl_jzmm"><input name="" type="checkbox" value="" /> 记住密码，下次自动登录</div>
{{csrf_field()}}
<div class="dl_dl"><input name="" type="submit" value="登 录" onmousedown="this.style.left='1px';this.style.top='1px';" onmouseup="this.style.left='0px';this.style.top='0px';" / style="width:135px; height:39px; border:none; background:url(/h/images/dl_dl.jpg); color:#FFF; font-size:14px; font-family:'微软雅黑'; position:relative;"><a href="/forget">忘记密码？</a></div>
</form>
<div class="denglu_sm">
<span style="color:#529014; font-weight:600;">如果您还不是本亲生活的会员?</span><br />
<span>30秒轻松注册，就可方便购物，赶紧点击下方注册</span>
</div>
<div class="denglu_hmzc" style="margin-bottom:20px"><a href="/home/register">立即注册</a></div>
